...
export const toolHandlers: Record<string, ToolHandler> = {
  ...
  'file_outline': (args) => import('./read').then(m => m.handleFileOutline(args)),
  ...
  'browser_get_element': (args) => import('./browser').then(m => m.browser_get_element(args as any).then(r => browserResult(r, r.found, r.error))),
  'browser_get_elements': (args) => import('./browser').then(m => m.browser_get_elements(args as any).then(r => browserResult(r, true, r.error))),
  'browser_evaluate': (args) => import('./browser').then(m => m.browser_evaluate(args as any).then(r => browserResult(r, r.success, r.error))),
  'browser_scroll': (args) => import('./browser').then(m => m.browser_scroll(args as any).then(r => browserResult(r, r.success, r.error))),
  'browser_wait_for': (args) => import('./browser').then(m => m.browser_wait_for(args as any).then(r => browserResult(r, r.found, r.error))),
  'browser_screenshot': (args) => import('./browser').then(m => m.browser_screenshot(args as any).then(r => browserResult(r, r.success, r.error))),
};
