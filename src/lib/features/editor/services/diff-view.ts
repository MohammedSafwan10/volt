...
import { setReviewHighlight, clearReviewHighlight, revealLine, getActiveEditor } from '$core/services/monaco-models';
...
export { clearReviewHighlight } from '$core/services/monaco-models';
