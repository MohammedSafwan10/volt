...
import { loadMonaco, detectLanguage as unifiedDetectLanguage } from '$core/services/monaco-loader';
import { getOrCreateModel, getActiveEditor } from '$core/services/monaco-models';
